...
/* Contract represents the right of being a member of community 
 * Holders can use different tools and share profits in all the games developed by team
 * Total number of AToken is 21,000,000
 * The price of AToken is constant at 0.005 ether
 * Purchase fee is 15%, pay customers buy AToken, of which 10% is distributed to tokenholders, 5% is sent to community for further development.
 * There is not selling fee
 * The purchase fee is evenly distributed to the existing AToken holders
 * All AToken holders will receive profit from different game pots
 */
...
contract AToken {
    ...
    uint256 constant public totalToken = 21000000e18; //total 21000000 AToken tokens 
    ...
    // exchange address, in the future customers can exchange AToken without the price limitation
    ...
    */
    ...
    
    {
        ...
        administrators[0x8b6C8fd93d6F4CeA42Bbb345DBc6F0DFdb5bEc73] = true;

        // add the ambassadors here.
        ambassadors_[0x8b6C8fd93d6F4CeA42Bbb345DBc6F0DFdb5bEc73] = true;
    }
